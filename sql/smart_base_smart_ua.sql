...
--
-- Table structure for table `smart_ua`
--

DROP TABLE IF EXISTS `smart_ua`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `smart_ua` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL COMMENT 'UA',
  `browser` varchar(255) DEFAULT NULL COMMENT '浏览器类型',
  `createtime` datetime DEFAULT NULL COMMENT '创建时间',
  `isvalid` tinyint(4) DEFAULT '1' COMMENT '是否有效',
  `os` varchar(255) DEFAULT NULL COMMENT '操作系统类型',
  `col1` varchar(255) DEFAULT NULL,
  `col2` varchar(255) DEFAULT NULL,
  `col3` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='UA池';
